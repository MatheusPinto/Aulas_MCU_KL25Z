...
/*! @name PORTB19 (number 54), D3[4]/LEDRGB_GREEN
  @{ */
#define BOARD_INITPINS_MEU_LED_GPIO GPIOB /*!<@brief GPIO device name: GPIOB */
#define BOARD_INITPINS_MEU_LED_PORT PORTB /*!<@brief PORT device name: PORTB */
#define BOARD_INITPINS_MEU_LED_PIN 19U    /*!<@brief PORTB pin index: 19 */
                                          /* @} */
