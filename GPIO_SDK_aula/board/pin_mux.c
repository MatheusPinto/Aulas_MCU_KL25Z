...
board: FRDM-KL25Z
pin_labels:
- {pin_num: '54', pin_signal: TSI0_CH12/PTB19/TPM2_CH1, label: 'D3[4]/LEDRGB_GREEN', identifier: LED_GREEN;MEU_LED}
...
- pin_list:
  ...
  - {pin_num: '54', peripheral: GPIOB, signal: 'GPIO, 19', pin_signal: TSI0_CH12/PTB19/TPM2_CH1, identifier: MEU_LED, direction: OUTPUT, gpio_init_state: 'true'}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t MEU_LED_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 1U
    };
    /* Initialize GPIO functionality on pin PTB19 (pin 54)  */
    GPIO_PinInit(BOARD_INITPINS_MEU_LED_GPIO, BOARD_INITPINS_MEU_LED_PIN, &MEU_LED_config);
    ...
    PORT_SetPinMux(BOARD_INITPINS_MEU_LED_PORT, BOARD_INITPINS_MEU_LED_PIN, kPORT_MuxAsGpio);
