...
/* Symbols to be used with PORT driver */
#define MY_ADC_PORT PORTE                /*!<@brief PORT peripheral base pointer */
#define MY_ADC_PIN 20U                   /*!<@brief PORT pin number */
#define MY_ADC_PIN_MASK (1U << 20U)      /*!<@brief PORT pin mask */
                                         /* @} */
